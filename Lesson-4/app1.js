...
var formValidation = function (e) {
    ...
    if (result == false) {
        document.getElementById('form-box__area__headline').innerText = "Ошибка заполнения формы, попробуйте снова"
    }
    if (result == true) {
        document.getElementById('form-box__area__headline').innerText = "Ваши данные отправлены"
    }
